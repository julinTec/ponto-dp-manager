...
const signUpSchema = signInSchema.extend({
  ...
  empresa: z.string().trim().min(2, "Informe a empresa").max(150),
});
...
export default function Auth() {
  ...
  async function handleSignUp(e: React.FormEvent<HTMLFormElement>) {
    ...
    setLoading(false);
    if (error) {
      if (error.message.includes("already")) toast.error("E-mail já cadastrado");
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="empresa" name="empresa" required maxLength={150} />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="email-s">E-mail corporativo</Label>
